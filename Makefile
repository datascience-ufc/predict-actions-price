IMAGE = predict-actions-price
PACKAGE = predict_actions_price
...
help:
	...
	@echo "    PARAMS             Parameters to pass as: $ predict_actions_price <command> $(PARAMS)."
...
clean: clean-dist
	rm -rf predict_actions_price.egg_info
